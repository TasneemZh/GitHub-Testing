...
class Home:
    ...
    def determine_repository_visibility(self, option, to_check):
        self.repository_creation.manage_visibility_option(option, to_check)

    def click_on_action_button(self, button_text):
        self.buttons_click.click_on_buttons_by_xpath("//button[@type='submit']", button_text, "Homepage")
